        ...
        <main style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ background: 'linear-gradient(135deg,rgba(34,197,94,0.07),rgba(99,102,241,0.07))', border: '1px solid rgba(34,197,94,0.2)', borderRadius: 14, padding: '20px 22px', marginBottom: 44 }}>
            <p style={{ color: '#d1fae5', fontFamily: 'system-ui,sans-serif', fontSize: 15, lineHeight: 1.8, margin: 0 }}>
              Welcome to <strong style={{ color: '#22c55e' }}>Ascivan</strong>. By accessing our website, requesting a consultation, or engaging our services, you agree to be bound by these Terms of Service. Please read them carefully before proceeding.
            </p>
          </div>
          ...
          <TosSection id="consultation" number="02" title="Consultation Fee" icon="💳" highlight>
            <TosCallout color="#22c55e" icon="💡" title="How Our Consultation Works">
              Before any project begins, Ascivan conducts a comprehensive discovery consultation to understand your goals, existing systems, technical requirements, and desired outcomes. This allows us to design the most effective intelligent solution for your specific needs.
            </TosCallout>
            ...
            <Subsection title="Consultation Fee Amount">
              ...
              <TosCallout color="#f59e0b" icon="📌" title="Fee Subject to Change">
                Ascivan reserves the right to adjust the consultation fee at any time at its sole discretion. Any change to the fee will be reflected on our website prior to taking effect. The fee in place at the time you submit your consultation request is the fee that applies to your engagement.
              </TosCallout>
            </Subsection>

            <Subsection title="What the Consultation Fee Covers">
              <ul>
                <li>A dedicated discovery session with a Ascivan solutions specialist</li>
          ...
          <TosSection id="pricing" number="04" title="Pricing & Project Timelines" icon="📊">
            <p>Project pricing at Ascivan is <strong>customized and scope-dependent</strong>. There is no one-size-fits-all rate, as every intelligent system we build is tailored to the unique needs, complexity, and goals of each Client.</p>
          ...
          <TosSection id="refunds" number="05" title="Refund Policy" icon="🔁">
            ...
            <Subsection title="Project Payment Refunds">
              <p>Refund terms for project payments are determined on a case-by-case basis and will be explicitly stated in the signed Project Agreement. Once work has commenced on a milestone, payments associated with that milestone are generally non-refundable unless Ascivan fails to deliver the agreed-upon work.</p>
            </Subsection>
          ...
          <TosSection id="ip" number="06" title="Intellectual Property" icon="⚖️">
            ...
            <Subsection title="Ascivan Proprietary Assets">
              <p>Ascivan retains ownership of all pre-existing tools, frameworks, methodologies, AI models, and proprietary systems used in delivering client projects. Use of these assets within your delivered project is licensed, not transferred.</p>
            </Subsection>
          ...
          <TosSection id="contact" number="08" title="Contact & Questions" icon="✉️">
            ...
            <p style={{ marginTop: 20, color: '#9ca3af', fontFamily: 'system-ui,sans-serif', fontSize: 14 }}>
              By engaging with Ascivan's services or paying the consultation fee, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
            </p>
