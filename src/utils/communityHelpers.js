 ...
 */
const compressImage = (file, maxSizeMB = 1, maxDimension = 1920) => {
...
export const uploadImageToStorage = async (file, folder = 'posts') => {
  try {
    ...
    // Compress image before upload to stay under Vercel 4.5MB body limit
    const { base64: base64Data, contentType: compressedType } = await compressImage(file);
