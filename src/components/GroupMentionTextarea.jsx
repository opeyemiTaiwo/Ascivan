  ...
  return (
    <div className="relative w-full">
      ...
      {showSuggestions && suggestions.length > 0 && (
        <div 
          ref={suggestionsRef}
          className="absolute z-50 w-full sm:max-w-sm md:max-w-md lg:max-w-lg bg-gray-900/95 backdrop-blur-xl border border-white/20 rounded-lg shadow-2xl max-h-56 sm:max-h-64 md:max-h-72 overflow-y-auto"
          style={{
            top: '100%',
            left: 0,
            marginTop: '4px'
