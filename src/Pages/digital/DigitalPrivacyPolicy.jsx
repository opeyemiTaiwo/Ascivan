        ...
        <main style={{ flex: 1, minWidth: 0 }}>
          ...
          <PPSection id="sharing" number="04" title="Sharing & Disclosure" icon="🔗">
            <PPCallout color="#ef4444" icon="🔒" title="We Do Not Sell Your Data">
              Loomiq does not sell, rent, or trade your personal information to third parties for their marketing purposes. Period.
            </PPCallout>
            ...
            <Subsection title="Within Our Organization">
              <p>Your information may be accessed by Loomiq team members — project managers, developers, and support staff — who need it to deliver services to you.</p>
            </Subsection>
          ...
          <PPSection id="rights" number="07" title="Your Rights & Choices" icon="⚖️" highlight>
            <p>Depending on your location, you may have certain rights regarding your personal data. Loomiq respects and honors these rights:</p>
          ...
          <PPSection id="security" number="08" title="Security" icon="🛡️">
            <p>Protecting your personal information is a priority at Loomiq. We implement industry-standard security measures to safeguard your data, including:</p>
            <ul>
          ...
          <PPSection id="children" number="09" title="Children's Privacy" icon="👶">
            <p>Loomiq's services are not directed to individuals under the age of 13, and we do not knowingly collect personal information from children under 13. If you are a parent or guardian and believe your child has provided us with personal information, please contact us immediately and we will take prompt steps to delete that information.</p>
          </PPSection>

          {/* ─── 10 Third-Party ─── */}
          <PPSection id="third-party" number="10" title="Third-Party Links & Platforms" icon="🔗">
            <p>Our website may contain links to third-party websites, social media platforms, and external resources including LinkedIn, Instagram, Facebook, and YouTube. This Privacy Policy applies only to Loomiq's owned platform and does not govern the privacy practices of any third-party site.</p>
            <p>We encourage you to review the privacy policies of any third-party platforms you visit through links on our website. Loomiq is not responsible for the privacy practices or content of external sites.</p>
          </PPSection>
          ...
          <PPSection id="contact" number="12" title="Contact Us" icon="✉️">
            ...
            <p style={{ color: '#9ca3af', fontFamily: 'system-ui,sans-serif', fontSize: 14 }}>
              We take all privacy inquiries seriously and will respond within a reasonable timeframe. By using Loomiq's platform, you acknowledge that you have read and understood this Privacy Policy.
            </p>
