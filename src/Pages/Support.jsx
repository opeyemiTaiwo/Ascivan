...
const Support = () => {
  ...
  const faqs = [
    ...
    { q: 'Is my personal data safe?', a: 'Yes. All user information is securely saved and protected. Your data can be used to track any person who engages in fraud or misconduct on the platform. Read our Privacy Policy for full details.' },
    ...
    { q: 'Are job, housing, and project listings verified by Loomiqe?', a: 'No. All jobs, projects, and housing listings are posted by users and are not independently verified by Loomiqe. We recommend you do your own due diligence before committing to any opportunity. All user information is securely stored and can be used to track misconduct.' },
    ...
    { q: 'Can I verify my identity on Loomiqe?', a: 'Yes. You can verify your identity by uploading a valid government-issued ID (National ID, Drivers Licence, or Passport) from your Dashboard Profile. This helps build trust with other members and project owners.' },
  ];
