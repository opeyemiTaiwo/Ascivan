...
const Support = () => {
  ...
  const faqs = [
    ...
    { q: 'Is Ascivan free to use?', a: 'Yes. The Basic plan is free and includes unlimited collaborative projects, free access to Foundations courses in every track, community, messaging, project workspaces, badges, and certificates - no caps or fees on building your skills. Premium ($200/year or $20/month) adds discovery and hiring features: full access to the Talent Board with unlimited talent messaging (contact unlimited new talents, no monthly cap), priority Talent Board ranking, a verified Premium Badge, posting paid projects, and priority support.' },
    { q: 'What are the advantages of Premium membership?', a: 'Premium ($200/year or $20/month) gives you: (1) A verified Premium Badge (orange PRO badge) shown across the platform, signalling you are a verified, trustworthy member or company. (2) Access to the Talent Board - browse and search the full directory of verified tech professionals, with unlimited talent messaging: contact unlimited new talents, with no monthly cap. (3) Priority Talent Board ranking - Premium members appear first in searches. (4) Post paid projects - hire real teams and set the pay per person for every role. (5) Priority support. Everything skill-building stays free on Basic: unlimited collaborative projects, free Foundations courses, badges, certificates, and being listed on the Talent Board once you earn badges - Premium is about getting discovered faster and hiring with confidence.' },
