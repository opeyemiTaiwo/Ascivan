          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5 mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <p className="text-yellow-700 text-xs font-medium mb-1">Pending</p>
                <p className="text-xl font-bold text-yellow-700">${earnings.pending.toLocaleString('en-US', { minimumFractionDigits: 2 })}</p>
                <p className="text-yellow-600 text-xs mt-1">From active projects</p>
              </div>
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <p className="text-green-700 text-xs font-medium mb-1">Earned</p>
                <p className="text-xl font-bold text-green-700">${earnings.earned.toLocaleString('en-US', { minimumFractionDigits: 2 })}</p>
                <p className="text-green-600 text-xs mt-1">From completed projects</p>
              </div>
