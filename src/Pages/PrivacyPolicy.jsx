...
const PrivacyPolicy = () => {
  const sections = [
    ...
    { title: '12. Third-Party Services', content: 'Ascivan integrates with Google Authentication and Google Cloud services. These services have their own privacy policies. We encourage you to review them.' },
