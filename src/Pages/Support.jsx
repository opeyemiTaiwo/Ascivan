...
const Support = () => {
  ...
  const faqs = [
    ...
    { q: 'What if I\'m not paid for a paid project?', a: 'If you have not been paid, do not confirm payment when the project owner moves the project toward completion - raise a dispute instead. A disputed project cannot be completed until it is resolved, and the matter is flagged to Ascivan admins. Keep your communications in the project Discussion tab, since those logs serve as your record. You can also report through this support page with details and any receipts.' },
