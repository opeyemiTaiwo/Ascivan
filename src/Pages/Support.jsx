...
const Support = () => {
  ...
  const faqs = [
    ...
    { q: 'Is Ascivan free to use?', a: 'Yes. Core features including projects, community, messaging, Foundations courses, and badges are free for all members. Basic (free) members can complete a limited number of paid projects per year. Premium members get unlimited paid projects plus added visibility and credibility features.' },
    { q: 'What are the advantages of Premium membership?', a: 'Premium gives you: (1) A verified Premium Badge (orange PRO badge) shown across the platform, signalling you are a verified, trustworthy professional. (2) Unlimited paid projects with no yearly cap. (3) Talent Board visibility, where recruiters and companies search for people to hire. (4) Top Talent visibility - members who earn badges or get high ratings for teaching community Foundations lessons surface to companies on the Proof Wall. (5) Priority support. Premium members stand out in applications, project teams, and the directory.' },
