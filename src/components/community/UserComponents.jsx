// src/components/community/UserComponents.jsx - Loomiq User Interaction Components - FULLY RESPONSIVE
...
/**
 * Enhanced Clickable User Name Component for Loomiq
...
export const EnhancedClickableUserName = ({ user, className = "", children, showTitle = true }) => {
  ...
  const displayName = user?.firstName && user?.lastName 
    ...
    : user?.displayName || user?.name || 'Loomiq Member';
      ...
      {onRemoveTag && (
        <div className="flex items-center justify-between mb-2 xs:mb-3">
          <h4 className="text-orange-300 font-medium text-xs xs:text-sm flex items-center gap-1 xs:gap-2">
            ...
            Tagged Loomiq Members ({taggedUsers.length}):
          </h4>
          <button
            type="button"
