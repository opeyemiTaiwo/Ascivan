...
const Support = () => {
  ...
  const faqs = [
    ...
    { q: 'How are badges earned?', a: 'Badges are earned automatically when a project is completed. Your badge type is based on your role: developers earn TechDev, QA testers earn TechQA, product owners earn TechPO, leaders earn TechLeads, low/no-code builders earn TechArchs, and security specialists earn TechGuard. Badge levels progress from Novice to Associate to Advanced to Expert based on how many projects you\'ve completed in that track.' },
