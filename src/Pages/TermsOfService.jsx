...
const TermsOfService = () => {
  const sections = [
    ...
    { title: '10. Membership Tiers', content: 'Loomiqe offers a Free tier (access to projects, community, messaging, and badges) and a Premium tier ($200/year or $20/month, which includes Talent Board visibility and advanced features). All members are Free by default. Premium features may change over time.' },
